...
*/
$transientName = 'dslv_cache_query_allpost';
...
function devvn_delete_all_transient_khoahoc() {
    global $wpdb;
    $menus = $wpdb->get_col( 'SELECT option_name FROM '.$wpdb->prefix.'options WHERE option_name LIKE "_transient_dslv_cache_query_%" ' );
